...
const demoDependencies: Dependency[] = [
  { id: '1', sourceIssue: { key: 'CF-142', title: 'Button/Primary token drift', board: { name: 'Mobil Uygulama DS' } }, targetIssue: { key: 'CF-138', title: 'Color/Brand master', board: { name: 'Brand Kit' } }, type: 'blocked_by', isCriticalPath: true },
  { id: '2', sourceIssue: { key: 'CF-143', title: 'Card/Product spacing ihlali', board: { name: 'Mobil Uygulama DS' } }, targetIssue: { key: 'CF-142', title: 'Button/Primary token drift', board: { name: 'Mobil Uygulama DS' } }, type: 'blocked_by', isCriticalPath: true },
  { id: '3', sourceIssue: { key: 'CF-136', title: 'Input/Field variant', board: { name: 'Web App DS' } }, targetIssue: { key: 'CF-135', title: 'Typography/Scale base', board: { name: 'Web App DS' } }, type: 'relates_to', isCriticalPath: false },
  { id: '4', sourceIssue: { key: 'CF-140', title: 'Modal/Dialog instance', board: { name: 'Marketing Site' } }, targetIssue: { key: 'CF-138', title: 'Color/Brand master', board: { name: 'Brand Kit' } }, type: 'blocked_by', isCriticalPath: false },
];
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="font-display text-3xl font-bold">Bileşen Etki Radarı</h1>
          <p className="text-muted-foreground">Cross-file component ilişkileri ve blast radius</p>
        </div>
